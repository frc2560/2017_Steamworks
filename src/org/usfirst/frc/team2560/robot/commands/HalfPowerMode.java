 ...
 *
 */
public class HalfPowerMode extends Command {

    public HalfPowerMode() 
    {
    ...
    protected void execute() 
    {
    	...
    	Robot.drivetrain.arcadeDrive(-Robot.oi.joystick0.getRawAxis(1)*multiplier, -Robot.oi.joystick0.getRawAxis(3));
    }
